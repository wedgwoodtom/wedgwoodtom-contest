...
@SpringComponent
@UIScope
public class ContestEditorOld extends VerticalLayout
{
    ...
    @Autowired
    public ContestEditorOld(ContestManager contestManager)
    {
    ...
    public void setChangeHandler(ContestEditorOld.ChangeHandler h)
    {
